                    ...
                    {showGoogleWarning && (
                      ...
                      >
                        <p className="text-sm text-yellow-800 dark:text-yellow-200">
                          <strong>Google sign-in temporarily unavailable.</strong> Please use email magic link below.
                        </p>
                      </motion.div>
                    )}

                    {/* Google Sign In - Disabled with tooltip */}
                    <div className="relative">
                      <Button
                        variant="outline"
                        className="w-full h-12 text-base border-2 opacity-50 cursor-not-allowed"
                        type="button"
                        disabled
                      ...
                      >
                        ...
                        Continue with Google (Temporarily Unavailable)
                      </Button>
                      <p className="text-xs text-center text-muted-foreground mt-2">
                        Google OAuth is being configured. Use email below.
                      </p>
                    </div>
                    ...
                    <div className="relative">
                      ...
                      <div className="relative flex justify-center text-xs uppercase">
                        <span className="bg-white dark:bg-gray-900 px-2 text-muted-foreground">
                          Sign in with email (recommended)
                        </span>
                      </div>
                    </div>
