...
import { googleAuthURL, sendMagicLink, API_BASE } from "@/lib/api"
...
export default function Page(){
  ...
  async function handleMagicLink() {
    ...
    try {
      ...
      console.log('[AUTH PAGE] Sending magic link to:', email)
      console.log('[AUTH PAGE] Magic link redirect URL:', redirectUrl)

      await sendMagicLink(email, redirectUrl)
      setSent(true)
      console.log('[AUTH PAGE] Magic link sent successfully')
    } catch(e: any) {
      console.error('[AUTH PAGE] Magic link error:', e)
      setAuthError(e?.message || 'Failed to send magic link. Please try again.')
    } finally {
      setLoading(false)
    }
  }
            ...
            <Card className="border-2 border-purple-200 dark:border-purple-800 shadow-2xl shadow-purple-500/20 backdrop-blur-lg bg-white/90 dark:bg-gray-900/90">
              ...
              <CardHeader className="pt-8">
                ...
                <CardDescription className="text-base">
                  Choose your preferred sign-in method - account created automatically
                </CardDescription>
              </CardHeader>
